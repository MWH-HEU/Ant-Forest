 ...
 *    （排除"玩一场能量雨"、"添加1份看病保障"、"去淘宝看科普视频"、"去蚂蚁阿福健康问答"、"去百度看蚂蚁森林"、"逛一逛点淘得红包"）
 ...
 * 排除：玩一场能量雨、添加1份看病保障、去淘宝看科普视频、去蚂蚁阿福健康问答、去百度看蚂蚁森林、逛一逛点淘得红包（检查按钮附近是否有排除文字）
        ...
        try {
          ...
          if (t) {
            ...
            if (text.indexOf('逛一逛') >= 0 || text.indexOf('去看看') >= 0 || 
              ...
              let skipReasons = ['玩一场能量雨', '添加1份看病保障', '去淘宝看科普视频', '去蚂蚁阿福健康问答', '去百度看蚂蚁森林', '逛一逛点淘得红包']
              try {
              ...
              if (allNodes2) {
                for (let n = 0; n < allNodes2.size(); n++) {
                  try {
                    ...
                    if (nt) {
                      let nText = nt.toString()
                      if (nText.indexOf('添加1份看病保障') >= 0 || nText.indexOf('玩一场能量雨') >= 0 || nText.indexOf('去淘宝看科普视频') >= 0 || nText.indexOf('去蚂蚁阿福健康问答') >= 0 || nText.indexOf('去百度看蚂蚁森林') >= 0 || nText.indexOf('逛一逛点淘得红包') >= 0) {
                        let nb = allNodes2.get(n).bounds()
                        if (Math.abs(nb.centerY() - bounds.centerY()) < 200) {
