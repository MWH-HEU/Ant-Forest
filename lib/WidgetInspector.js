 ...
 *   2. detectAllNodes()  - 所有控件检测（含可点击、className）
 *   3. detectByOcr()     - OCR 识别所有文字
 *   4. detectAll()       - 一键执行全部三种方法
 *   5. getNodeText()     - 安全获取控件文本
 *   6. getNodeBounds()   - 安全获取控件 bounds
 * 
 * 用法：
